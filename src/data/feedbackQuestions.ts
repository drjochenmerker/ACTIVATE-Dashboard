/**
 * This file contains the static content for the feedback questions because they may vary
 * It also provides the terms in the 3 main languages English, German and Swedish
 */
export const staticContentFeedback = {
    feedbackpage: {
    ...
    objectQuestion: {
        title: {
            en: "Object(ive) (Goal of the joint activity)",
    ...
    rulesQuestion: {
        title: {
            ...
            sv: "Regler (normer, riktlinjer och implicita förväntningar)",
        },
        // temporary version:
        // question1: {
