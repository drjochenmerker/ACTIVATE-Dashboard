...
import CustomDialog from "./ui/dialog/CustomDialog.vue";
...
const getCommentText = (comment: any) => {
    ...
    return commentRecord[sessionStore.activeLanguage] || commentRecord.default || Object.values(commentRecord)[0] || "";
};
...
<template>
    <div class="reply-card" :class="{ dark: colorMode === 'dark' }">
        <CustomDialog v-model:open="isEditDialogOpen">
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>
            ...
            <div class="reply-head">
                <p class="reply-author">
                    {{
                        ...
                        Object.values(props.parentComment.author?.labels || {}).find(
                ...
                <div class="flex items-center gap-2">
                    <!-- Edit button -->
                    <button
                        v-if="props.showEdit && sessionStore.instructorView"
                        class="icon-button"
