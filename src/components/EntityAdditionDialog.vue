...
let activityClassOptions = [
    ...
    { label: activateTerms[sessionStore.activeLanguage].instruments, value: KnowledgeGraphActivityClass.instruments },
    {
        ...
        value: KnowledgeGraphActivityClass.divison_of_labour,
    },
    ...
    () => {
        activityClassOptions = [
            ...
            { label: activateTerms[sessionStore.activeLanguage].rules, value: KnowledgeGraphActivityClass.rules },
            {
                ...
                value: KnowledgeGraphActivityClass.instruments,
            },
            {
                label: activateTerms[sessionStore.activeLanguage].division_of_labour,
                value: KnowledgeGraphActivityClass.divison_of_labour,
            },
            {
                ...
                value: KnowledgeGraphActivityClass.community,
            },
        ];
    },
);
        ...
        <div :class="mode === 'dark' ? 'modal-container dark' : 'modal-container light'">
            ...
            <div class="inputs-container mb-4">
                <div class="input-group">
                    <label for="entityName" class="input-label">{{
                        staticContent.entitiyAdd.entityName[sessionStore.activeLanguage]
                    }}</label>
                    <input
                        id="entityName"
                        type="text"
                ...
                <div class="input-group">
                    <label for="entityClass" class="input-label">{{
                        staticContent.entitiyAdd.activityClass[sessionStore.activeLanguage]
                    }}</label>
                    <select id="entityClass" v-model="selectedClass" class="input-field">
                        <option disabled value="">
                            {{ staticContent.entitiyAdd.selectClass[sessionStore.activeLanguage] }}
                        </option>
