            ...
            <CardHeader class="flex justify-center items-center">
                <CardTitle class="flex justify-center w-full">
                    <div class="flex flex-col items-center w-full">
                        <h1 class="text-center text-4xl font-semibold mb-4">Debriefing-Dashboard</h1>
                    ...
                    <DialogContent class="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <textarea
                                ...
                                class="w-full border rounded p-2 mb-1 dark:bg-gray-900"
                                :class="[
                                    showValidationErrors && !newDescription.trim()
                                        ? 'border-red-500'
                                        : 'border-gray-300',
                                ]"
                            />
                            ...
                            <DialogDescription
                                >{{ staticContent.startPage.defaultRole[sessionStore.activeLanguage] }}
                            </DialogDescription>
                            <input
                                v-model="defaultRole"
                                class="w-full border rounded p-2 mb-2 dark:bg-gray-900 border-gray-300"
